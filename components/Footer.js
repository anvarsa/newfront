      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-xs">
            <li><Link href="/xizmatlar" className="hover:text-emerald-400 transition">Barcha xizmatlar</Link></li>
            <li><Link href="/narxlar" className="hover:text-emerald-400 transition">Xizmatlar narxnomasi</Link></li>
            <li><Link href="/kafolat" className="hover:text-emerald-400 transition">Kafolat shartlari</Link></li>
            <li><Link href="/vakansiyalar" className="hover:text-emerald-400 transition">Bo'sh ish o'rinlari</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs">
            ...
            <li className="flex justify-between text-emerald-400 font-medium pt-0.5">
              <span>Yakshanba:</span>
